package sceondtest.tn.stepdefinitions;
...
import sceondtest.tn.elementspage.MasterPageFactory;
...
public class FunctionalStepDef extends ParentClass {
	...
	MasterPageFactory pf; // Instance variable in global level.

	@Given("Verify that home page is visible successfully")
	public void verify_that_home_page_is_visible_successfully() {

		pf = new MasterPageFactory(); // object
		pf.getLogin(prop.getProperty("UserName"), prop.getProperty("Password"));// Login method
		
		// Verify the home page
       String text =  pf.getVerifyHomePage().getText();  // Store in to string variable, with method name and then verify the home page i need text method.
